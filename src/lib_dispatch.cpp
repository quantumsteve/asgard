...
template void sparse_gemv(char const *trans, int *rows, int *cols, int *nnz,
                          const int *offsets, const int *columns, const float *A, float *alpha,
                          const float *x, float *beta, const float *y,
...
template void sparse_gemv(char const *trans, int *rows, int *cols, int *nnz,
                          const int *offsets, const int *columns, const double *A, double *alpha,
                          const double *x, double *beta, const double *y,
                          resource const resrc);
