...
void reduce_results(fk::vector<P, mem_type::owner, input_mode> const &source,
                    fk::vector<P, mem_type::owner, input_mode> &dest,
...
template<typename P, resource input_mode>
void exchange_results(fk::vector<P, mem_type::owner, input_mode> const &source,
                      fk::vector<P, mem_type::owner, input_mode> &dest,
